...
{
	/// <summary>
	/// 数据访问类:R_UserInfo_ActionInfoDAL
	/// </summary>
	public partial class R_UserInfo_ActionInfoDAL
	{
		...
		public book_shop.Model.R_UserInfo_ActionInfoModel GetModel(int ID)
		{
			...
			book_shop.Model.R_UserInfo_ActionInfoModel model=new book_shop.Model.R_UserInfo_ActionInfoModel();
		...
		/// 得到一个对象实体
		/// </summary>
		public book_shop.Model.R_UserInfo_ActionInfoModel DataRowToModel(DataRow row)
		{
			book_shop.Model.R_UserInfo_ActionInfoModel model=new book_shop.Model.R_UserInfo_ActionInfoModel();
			if (row != null)
			{
