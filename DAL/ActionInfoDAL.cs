...
namespace book_shop.DAL
{
	...
	public partial class ActionInfoDAL
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(book_shop.Model.ActionInfoModel model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(book_shop.Model.ActionInfoModel model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public book_shop.Model.ActionInfoModel GetModel(int ID)
		{
			...
			book_shop.Model.ActionInfoModel model=new book_shop.Model.ActionInfoModel();
		...
		/// 得到一个对象实体
		/// </summary>
		public book_shop.Model.ActionInfoModel DataRowToModel(DataRow row)
		{
			book_shop.Model.ActionInfoModel model=new book_shop.Model.ActionInfoModel();
			if (row != null)
			{
