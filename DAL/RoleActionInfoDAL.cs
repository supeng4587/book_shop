...
#warning 系统发现缺少更新的字段，请手工确认如此更新是否正确！ 
		...
		public book_shop.Model.RoleActionInfoModel GetModel(int Role_ID,int ActionInfo_ID)
		{
			...
			book_shop.Model.RoleActionInfoModel model=new book_shop.Model.RoleActionInfoModel();
		...
		/// 得到一个对象实体
		/// </summary>
		public book_shop.Model.RoleActionInfoModel DataRowToModel(DataRow row)
		{
			book_shop.Model.RoleActionInfoModel model=new book_shop.Model.RoleActionInfoModel();
			if (row != null)
			{
