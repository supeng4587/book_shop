...
#warning 系统发现缺少更新的字段，请手工确认如此更新是否正确！ 
		...
		public book_shop.Model.UserInfoRoleModel GetModel(int UserInfo_ID,int Role_ID)
		{
			...
			book_shop.Model.UserInfoRoleModel model=new book_shop.Model.UserInfoRoleModel();
		...
		/// 得到一个对象实体
		/// </summary>
		public book_shop.Model.UserInfoRoleModel DataRowToModel(DataRow row)
		{
			book_shop.Model.UserInfoRoleModel model=new book_shop.Model.UserInfoRoleModel();
			if (row != null)
			{
