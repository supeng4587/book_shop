...
#warning 系统发现缺少更新的字段，请手工确认如此更新是否正确！ 
		...
		public book_shop.Model.RoleActionGroupModel GetModel(int Role_ID,int ActionGroup_ID)
		{
			...
			book_shop.Model.RoleActionGroupModel model=new book_shop.Model.RoleActionGroupModel();
		...
		/// 得到一个对象实体
		/// </summary>
		public book_shop.Model.RoleActionGroupModel DataRowToModel(DataRow row)
		{
			book_shop.Model.RoleActionGroupModel model=new book_shop.Model.RoleActionGroupModel();
			if (row != null)
			{
