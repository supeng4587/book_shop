<%@ Page Title="" Language="C#" MasterPageFile="/Master/MainMaster.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="book_shop.Web.Member.Login" %>
                ...
                <div align="center">
                    <table height="61" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td valign="top" width="37%">&nbsp;<input type="text" name="txtLoginId" /></td>
                        </tr>
                    </table>
                    <table height="61" cellpadding="0" cellspacing="0">
                        <tr>
                        ...
                        <tr>
                            ...
                            <td valign="top" width="37%">&nbsp;<input type="password" name="txtLoginPwd" /></td>
                        </tr>
