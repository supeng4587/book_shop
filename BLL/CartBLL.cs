...
namespace book_shop.BLL
{
	...
	public partial class CartBLL
	{
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(book_shop.Model.CartModel model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(book_shop.Model.CartModel model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public book_shop.Model.CartModel GetModel(int Id)
		{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public book_shop.Model.CartModel GetModelByCache(int Id)
		{
			
			string CacheKey = "CartModelModel-" + Id;
			...
			return (book_shop.Model.CartModel)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<book_shop.Model.CartModel> GetModelList(string strWhere)
		{
